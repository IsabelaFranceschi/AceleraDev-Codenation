...
def predicao(portfolio):
    ...
    mercado_tratado = pd.read_csv('mercado.csv')
    ...
    # Selecionar apenas novos leads, desconsiderar as pessoas que já são clientes da empresa
...
st.image ('/Users/isabelafranceschi/Desktop/app/photo_app.jpg')

# subtítulo
st.markdown(
    "Esse produto recomenda leads do mercado para empresas dada a sua lista de clientes (portfolio).")
